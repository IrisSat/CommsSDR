...
class gnuradio_recorder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gnuradio_recorder")
...
def main(top_block_cls=gnuradio_recorder, options=None):
