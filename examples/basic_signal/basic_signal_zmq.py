...
class basic_signal_zmq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.satellites_satellite_decoder_0 = satellites.core.gr_satellites_flowgraph(file = '/home/billdion/Documents/Workshop Tutorials/AAUSAT-4.yml', samp_rate = samp_rate, grc_block = True, iq = False, options = "")
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/billdion/Documents/Workshop Tutorials/aausat_4.wav', True)
